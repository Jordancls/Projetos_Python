#1. crie uma saudação para o seu programa.
...
#4. combine o nome de sua cidade e animal de estimação e mostre a eles o nome de sua banda
print("O nome da sua banda pode ser " + street + " " + pet)
